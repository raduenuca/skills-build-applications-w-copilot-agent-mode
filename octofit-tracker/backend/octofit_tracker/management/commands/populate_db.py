...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Debugging: Print users to verify creation
        print("Users created:", list(User.objects.all()))
        ...
        # Debugging: Print teams to verify creation
        print("Teams created:", list(Team.objects.all()))
        ...
        # Debugging: Print activities to verify creation
        print("Activities created:", list(Activity.objects.all()))
        ...
        # Debugging: Print leaderboard entries to verify creation
        print("Leaderboard entries created:", list(Leaderboard.objects.all()))
        ...
        # Debugging: Print workouts to verify creation
        print("Workouts created:", list(Workout.objects.all()))
